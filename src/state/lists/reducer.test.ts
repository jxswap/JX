  ...
  describe('updateVersion', () => {
    describe('never initialized', () => {
      ...
      it('puts in all the new lists', () => {
        expect(Object.keys(store.getState().byUrl)).toEqual(DEFAULT_TOKEN_LIST_URL)
      })
      ...
      it('sets initialized lists', () => {
        expect(store.getState().lastInitializedDefaultListOfLists).toEqual(DEFAULT_TOKEN_LIST_URL)
      })
    })
